...
public function store(Request $request): JsonResponse
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        [
            ...
            'foto_kk.mimes' => 'Foto KK harus berformat jpeg, png, atau jpg.',
            'foto_kk.max' => 'Ukuran foto KK maksimal 2MB.',
            'foto_skck.image' => 'Foto SKCK harus berupa gambar.',
            'foto_skck.mimes' => 'Foto SKCK harus berformat jpeg, png, atau jpg.',
            'foto_skck.max' => 'Ukuran foto SKCK maksimal 2MB.',
            'pas_foto.image' => 'Pas foto harus berupa gambar.',
            'pas_foto.mimes' => 'Pas foto harus berformat jpeg, png, atau jpg.',
            'pas_foto.max' => 'Ukuran pas foto maksimal 2MB.',
            'surat_sehat.file' => 'Surat sehat harus berupa file.',
            'surat_sehat.mimes' => 'Surat sehat harus berformat pdf, jpeg, png, atau jpg.',
            'surat_sehat.max' => 'Ukuran surat sehat maksimal 2MB.',
            'surat_anti_narkoba.file' => 'Surat anti narkoba harus berupa file.',
            'surat_anti_narkoba.mimes' => 'Surat anti narkoba harus berformat pdf, jpeg, png, atau jpg.',
            'surat_anti_narkoba.max' => 'Ukuran surat anti narkoba maksimal 2MB.',
            'surat_lamaran.file' => 'Surat lamaran harus berupa file.',
            'surat_lamaran.mimes' => 'Surat lamaran harus berformat pdf.',
            'surat_lamaran.max' => 'Ukuran surat lamaran maksimal 2MB.',
